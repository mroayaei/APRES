        ...
        for step in range(algorithm["num_steps"]):
           ...
           # ---------------------------------------------------------
            ...
            for env_idx, info in enumerate(infos):
                if info and "intrinsic_rewards" in info:
                    intrinsic_reward[env_idx] = torch.as_tensor(
                        info["intrinsic_rewards"],
                        dtype=reward.dtype,
                        device=reward.device
                    )

            # Combine original RWARE reward + intrinsic reward
            reward = reward + intrinsic_coef * intrinsic_reward
